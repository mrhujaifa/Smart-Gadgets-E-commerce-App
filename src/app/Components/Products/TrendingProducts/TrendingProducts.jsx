...
export default function ProductCard({ product }) {
  ...
  return (
    <div className="relative w-full hover:shadow-lg transition flex flex-col justify-between p-4 group h-full">
      ...
      {/* Title */}
      <h5 className="text-[#0062bd] font-semibold text-sm mb-2 mt-1 line-clamp-2 cursor-pointer">
        {product.title}
      </h5>
      ...
      {/* Compare & Wishlist */}
      <div className="flex justify-start gap-4 text-gray-600 text-sm opacity-0 group-hover:opacity-100 transition">
