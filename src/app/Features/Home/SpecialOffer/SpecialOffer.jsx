      ...
      <div className="border-2  border-[#fed700] rounded-xl m p-4 w-full lg:w-lg h-full bg-white shadow-lg">
        <div className="">
          <div className="flex items-center justify-between">
            ...
            {/* Circle Badge */}
            <div className="bg-yellow-300 text-black w-20 h-20 flex flex-col items-center justify-center rounded-full shadow text-center">
          ...
          <div className="my-2">
            ...
            <div className="w-full bg-gray-200 h-6 rounded-full mt-1">
              <div className="bg-yellow-300 h-6 rounded-full w-[26%]"></div>
            </div>
          </div>
          ...
          <div className="flex justify-between text-center mt-2">
            {["HOURS", "MINS", "SECS"].map((label) => (
              <div
                key={label}
                className="bg-gray-100 p-1 rounded-md w-full mx-1"
              >
